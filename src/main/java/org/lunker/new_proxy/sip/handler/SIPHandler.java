...
/**
 * Created by dongqlee on 2018. 4. 24..
 */
public class SIPHandler {
    ...
    public List<GeneralSipMessage> process(ChannelHandlerContext ctx, GeneralSipMessage generalSipMessage){
        logger.info("[RECEIVED]:\n" + ((GeneralSipMessage) generalSipMessage).toString());
...
//                registrar.register(userKey, registration, currentCtx);
